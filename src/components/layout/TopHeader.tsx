...
export function TopHeader({ onMenuClick }: TopHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-[60px] items-center gap-4 lg:gap-6 border-b border-slate-200/90 bg-white/95 backdrop-blur-sm px-4 lg:px-6 shrink-0 min-w-0">
      <button
        onClick={onMenuClick}
