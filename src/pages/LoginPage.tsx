...
export function LoginPage() {
  ...
  const { login, isAuthenticated, updateUserName } = useAuth()
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      login('harsh.vardhan1@tothenew.com', 'google-sso', true)
      updateUserName('Harsh Vardhan')
  ...
  const handleMicrosoftLogin = async () => {
    ...
    try {
      await new Promise((r) => setTimeout(r, 800))
      login('harsh.vardhan1@tothenew.com', 'microsoft-sso', true)
      updateUserName('Harsh Vardhan')
      navigate(redirectTo, { replace: true })
    } finally {
      setLoading(false)
